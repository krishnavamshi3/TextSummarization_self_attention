...
def train_model(model, dataset, params, ckpt, ckpt_manager, out_file):
  ...
  def train_step(enc_inp, enc_extended_inp, dec_inp, dec_tar, batch_oov_len):
    ...
    variables = model.encoder.trainable_variables + model.attention.trainable_variables  +  model.self_attention.trainable_variables + model.decoder.trainable_variables + model.pointer.trainable_variables
