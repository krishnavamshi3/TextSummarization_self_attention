# Abstractive Text Summarization with self-attention and pointer networks

A multi-head self-attention based sequence-to-sequence neural network with pointer generator mechanism.
